...
test('emoji-cheat-sheet', async () => {
  expect(await generate()).toMatchInlineSnapshot(`
    ...
    [![Up to Date](https://github.com/nholuongut/emoji-cheat-sheet/workflows/Up%20to%20Date/badge.svg)](https://github.com/nholuongut/emoji-cheat-sheet/actions?query=workflow%3A%22Up+to+Date%22)
